...
final class Polyslug
{
     ...
     * @param  array<string, mixed>  $encoderOptions  Per-model encoder options giving this model its own token space. Which keys are read depends on the effective encoder: SqidsEncoder takes 'alphabet' and 'min_length'; RandomTokenEncoder and SequentialTokenEncoder take 'length' and 'alphabet'. Every other encoder ignores them.
